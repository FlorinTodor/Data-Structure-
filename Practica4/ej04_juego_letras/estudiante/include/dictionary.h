...
private:
    ...
    /**
      * @brief Método recursivo auxiliar del método público getOcurrences.
      * @param curr_node Nodo actual.
      *  @param c Letra de la cual buscar.
      * @return Devuelve las ocurrencias de la letra en el subarbol que cuelga de curr_node.
      * */
    int getOccurrences(node curr_node, char c);

    /**
     *  @brief Método recursivo auxiliar del método públco getTotalUsages
     *  @param curr_node Nodo actual.
     *  @param c Letra de la cúal buscar.
     *  @return el número de ocurrencias del carácter en los nodos que cuelgan del nodo actual, y el número de palabras que terminan por debajo del nodo actual.
     */
...
public:
    ...
    //////////////////////////////////////////////// Recursive functions ///////////////////////////////////////////////
/**
    * @brief Devuelve el número de ocurrencias de la letra pasada como parámetro en nuestro diccionario.
    * @param c Letra de la cúal queremos averiguar sus ocurrencias.
    * @return Número de ocurrencias.
  */
    int getOccurrences(const char c);

    /**
     * @brief Cuenta el número de usos de la letra pasada por parametro para formar palabras en el diccionario.
     * @param c Letra de la cúal queremos averiguar sus usos.
    ...
    public:
         ...
         * @param iter Iterador en preorden del tree.
          */
        iterator(tree<char_info>::const_preorder_iterator iter);
         ...
         /**
          ...
          /**
           *  @return El iterador apunta a la siguiente palabra
           */
            iterator &operator++();

           /**     *
             * @param other
             * @return Devuelve true si nuestro iterator es igual al pasado por parámetro.
             */    bool operator==(const iterator &other);

            /**
             * @param other
             *  @return Devuelve true si nuestro iterator es distinto al pasado por parámetro.
             * */    bool operator!=(const iterator &other);};


             /**
                *@return Apunta a la primera palabra del diccionario.
              */

             iterator begin() const;
                 /**
                   * @return Apunta a la última palabra del diccionario.
                 */
                 iterator end() const;
