...
/**
  ...
  */
    ...
    // Invierte
    void Invert(char *origen, char*destino);
     ...
     * @pre in1 < in2.
     * @pre out1 < out2.
     * @return Devuelve la Imagen que ha llamado al metodo con mayor contraste.
    ...
    * @param i indice de la fila donde se empieza.
    * @param j indice de la columna donde se empieza.
    * @param height altura de la imagen.
    * @param width anchura de la imagen.
    * @pre i < width
    * @pre j < height
    * @return Devuelve la media de todos los numeros de la zona seleccionada de la matriz original.
    * @post El valor devuelto es de tipo double.
    */
    double Mean (int i, int j, int height, int width) const;

    /**
     * @brief Genera un icono como reducción de una imagen .
     * @param factor Factor de reduccion de la imagen original respecto al icono .
     * @pre factor > 0 .
     * @return Devuelve un objeto imagen, el cual es la imagen iconizada .
     * @post La imagen original no se modifica .
     * @post La imagen resultante tendrá tamaño int(filas/factor) x int(columnas/factor). Descartando los decimales de la division .
     */
    ...
    /**
      ...
      * @return Devuelve una imagen, la cual es un recorte de la imagen original .
    ...
    /**
     * @brief Crea una imagen aumentada X2 de la imagen original.
     * @return Devuelve una imagen aumentada.
     */
    Image Zoom2X() const;
